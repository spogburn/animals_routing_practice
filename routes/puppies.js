...
//write a function thta takes two argumetns. one for the query you are going to make and the other for the callback it is going to run when the query is done. (think about parametized inputs )
